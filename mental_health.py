...
if authentication_status:
    ...
    ('Time spent on online class', 'Time spent on fitness', 'Time spent on TV','Time spent on sleep','Time spent on self-study','Time spent on social-media'))
        ...
        st.subheader("________________________________________________________________________________________________________________________________________________________")
